 ...
 *  draft hasn't been resolved yet -- not a real run until confirmDraft applies the choices. Held
 *  only in memory (not persisted): losing an in-progress draft to a refresh just means re-rolling,
 *  same cost as clicking "Start New Run" again. */
