...
describe('openShopVisit', () => {
  it('grants only single-player camp purchase power on the condensed tier, plus 1 upgrade offer and no reroll', () => {
  ...
  it('grants more player-camp purchase power plus team-camp purchase power on the expanded tier, plus 2 upgrade offers and a reroll', () => {
