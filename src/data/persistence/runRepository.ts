...
function isValidBundleShape(data: unknown): data is RunBundle {
  ...
  // accept and crash a screen reading them later) a save from before any of them existed.
  ...
  return (
    ...
    Array.isArray(run.consumableInventory) &&
    Array.isArray(run.activeConsumablesThisSeason)
  )
}
